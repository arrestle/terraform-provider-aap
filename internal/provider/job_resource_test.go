...
// testAccJobWithWaitForCompletion creates a job with wait_for_completion=true
// This configuration is designed to expose the AAP-47221 bug where the job status
// remains "pending" instead of updating to the final state.
